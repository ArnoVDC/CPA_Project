...
public class MainFragment extends Fragment {
        ...
        switch (requestCode) {
            case RequestCameraPermissionID:
            {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Log.d("Permission", "no permissions");
                }
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_main, container, false); // Final want nodig in nested functions, mag dit?

        // Vervangen door dataBinding
        cameraView = (SurfaceView) v.findViewById(R.id.surface_view);
        textView = (TextView) v.findViewById(R.id.text_view);

        TextRecognizer textRecognizer = new TextRecognizer.Builder(v.getContext()).build(); // getApplicationContext ?
        if (!textRecognizer.isOperational()) {
            ...
            cameraSource = new CameraSource.Builder(v.getContext(), textRecognizer)
                    ...
                    if (items.size() != 0) {
                        textView.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Log.d("Outcome", stringBuilder.toString());
